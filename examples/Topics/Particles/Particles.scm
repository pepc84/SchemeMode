...
(define (make-p x y)
  (list x y (random -2.0 2.0) (random -4.0 -0.5) (random 40.0 80.0)))

(define (p-x p) (list-ref p 0))
(define (p-y p) (list-ref p 1))
(define (p-vx p) (list-ref p 2))
(define (p-vy p) (list-ref p 3))
